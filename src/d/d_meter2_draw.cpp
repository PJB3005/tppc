...
dMeter2Draw_c::dMeter2Draw_c(JKRExpHeap* mp_heap) {
    ...
    void* msg_res = JKRGetTypeResource(TAG("ROOT"), "zel_00.bmg", dComIfGp_getMsgDtArchive(0));
    ...
    void* stg_msg_res = JKRGetTypeResource(TAG("ROOT"), bmg_filename[dMsgObject_getGroupID()],
                                           dComIfGp_getMsgDtArchive(1));
    dMeter2Info_setStageMsgResource(stg_msg_res);

    void* msg_unit_res = JKRGetTypeResource(TAG("ROOT"), "zel_unit.bmg", dComIfGp_getMsgDtArchive(0));
    ...
    mpScreen->search(TAG("ju_ring5"))->hide();
    field_0x73c = 0.0f;
    ...
    mpPikariParent = new CPaneMgr(mpPikariScreen, TAG("pika_n"), 0, NULL);
    JUT_ASSERT(0, mpPikariParent != NULL);
    mPikariBlack = static_cast<J2DPicture*>(mpPikariScreen->search(TAG("pika00")))->getBlack();
    mPikariWhite = static_cast<J2DPicture*>(mpPikariScreen->search(TAG("pika00")))->getWhite();
    ...
    static u64 const a_tag[] = {TAG("cont_at1"), TAG("cont_at2"), TAG("cont_at3"), TAG("cont_at4"), TAG("cont_at")};
    static u64 const b_tag[] = {TAG("cont_bt1"), TAG("cont_bt2"), TAG("cont_bt3"), TAG("cont_bt4"), TAG("cont_bt")};
    static u64 const z_tag[] = {TAG("cont_zt1"), TAG("cont_zt2"), TAG("cont_zt3"), TAG("cont_zt4"), TAG("cont_rt")};
    static u64 const x_tag[] = {TAG("cont_xt1"), TAG("cont_xt2"), TAG("cont_xt3"), TAG("cont_xt4"), TAG("cont_xt5")};
    static u64 const y_tag[] = {TAG("cont_yt1"), TAG("cont_yt2"), TAG("cont_yt3"), TAG("cont_yt4"), TAG("cont_yt5")};
...
void dMeter2Draw_c::initLife() {
    ...
    static u64 const life_tag[] = {
        TAG("hpb_00"), TAG("hpb_01"), TAG("hpb_02"), TAG("hpb_03"), TAG("hpb_04"), TAG("hpb_05"), TAG("hpb_06"),
        TAG("hpb_07"), TAG("hpb_08"), TAG("hpb_09"), TAG("hpb_10"), TAG("hpb_11"), TAG("hpb_12"), TAG("hpb_13"),
        TAG("hpb_14"), TAG("hpb_15"), TAG("hpb_16"), TAG("hpb_17"), TAG("hpb_18"), TAG("hpb_19"),
    };

    static u64 const mark_tag[] = {
        TAG("heartn00"), TAG("heartn01"), TAG("heartn02"), TAG("heartn03"), TAG("heartn04"), TAG("heartn05"), TAG("heartn06"),
        TAG("heartn07"), TAG("heartn08"), TAG("heartn09"), TAG("heartn10"), TAG("heartn11"), TAG("heartn12"), TAG("heartn13"),
        TAG("heartn14"), TAG("heartn15"), TAG("heartn16"), TAG("heartn17"), TAG("heartn18"), TAG("heartn19"),
    };

    static u64 const base_tag[] = {
        TAG("h_ba_n00"), TAG("h_ba_n01"), TAG("h_ba_n02"), TAG("h_ba_n03"), TAG("h_ba_n04"), TAG("h_ba_n05"), TAG("h_ba_n06"),
        TAG("h_ba_n07"), TAG("h_ba_n08"), TAG("h_ba_n09"), TAG("h_ba_n10"), TAG("h_ba_n11"), TAG("h_ba_n12"), TAG("h_ba_n13"),
        TAG("h_ba_n14"), TAG("h_ba_n15"), TAG("h_ba_n16"), TAG("h_ba_n17"), TAG("h_ba_n18"), TAG("h_ba_n19"),
    };

    static u64 const lifet1_tag[] = {
        TAG("hear_00s"), TAG("hear_01s"), TAG("hear_02s"), TAG("hear_03s"), TAG("hear_04s"), TAG("hear_05s"), TAG("hear_06s"),
        TAG("hear_07s"), TAG("hear_08s"), TAG("hear_09s"), TAG("hear_10s"), TAG("hear_11s"), TAG("hear_12s"), TAG("hear_13s"),
        TAG("hear_14s"), TAG("hear_15s"), TAG("hear_16s"), TAG("hear_17s"), TAG("hear_18s"), TAG("hear_19s"),
    };

    static u64 const lifet2_tag[] = {
        TAG("hear_00"), TAG("hear_01"), TAG("hear_02"), TAG("hear_03"), TAG("hear_04"), TAG("hear_05"), TAG("hear_06"),
        TAG("hear_07"), TAG("hear_08"), TAG("hear_09"), TAG("hear_10"), TAG("hear_11"), TAG("hear_12"), TAG("hear_13"),
        TAG("hear_14"), TAG("hear_15"), TAG("hear_16"), TAG("hear_17"), TAG("hear_18"), TAG("hear_19"),
    };

    mpLifeParent = new CPaneMgr(mpScreen, TAG("heart_n"), 2, NULL);
    ...
    mpBigHeart = new CPaneMgr(mpScreen, TAG("bigh_n"), 2, NULL);
...
void dMeter2Draw_c::initMagic() {
    ...
    mpMagicParent = new CPaneMgr(mpKanteraScreen, TAG("magic_n"), 2, NULL);
    JUT_ASSERT(0, mpMagicParent != NULL);

    mpMagicBase = new CPaneMgr(mpKanteraScreen, TAG("mm_base"), 0, NULL);
    JUT_ASSERT(0, mpMagicBase != NULL);

    mpMagicFrameL = new CPaneMgr(mpKanteraScreen, TAG("m_w_l_n"), 2, NULL);
    JUT_ASSERT(0, mpMagicFrameL != NULL);

    mpMagicFrameR =
        new CPaneMgr(mpKanteraScreen, TAG("m_w_r_n"), 2, NULL);
    JUT_ASSERT(0, mpMagicFrameR != NULL);

    mpMagicMeter = new CPaneMgr(mpKanteraScreen, TAG("mm_00"), 0, NULL);
...
void dMeter2Draw_c::initLightDrop() {
    mpLightDropParent = new CPaneMgr(mpScreen, TAG("s_tuta_n"), 2, NULL);
    ...
    static u64 const tuta_0[] = {
        ...
        TAG("s_08"), TAG("s_09"), TAG("s_10"), TAG("s_11"), TAG("s_12"), TAG("s_13"), TAG("s_14"), TAG("s_15"),
    };

    static u64 const tuta_1[] = {
        TAG("sl_00"), TAG("sl_01"), TAG("sl_02"), TAG("sl_03"), TAG("sl_04"), TAG("sl_05"), TAG("sl_06"), TAG("sl_07"),
        TAG("sl_08"), TAG("sl_09"), TAG("sl_10"), TAG("sl_11"), TAG("sl_12"), TAG("sl_13"), TAG("sl_14"), TAG("sl_15"),
    };

    static u64 const tuta_2[] = {
        TAG("scp_00"), TAG("scp_01"), TAG("scp_02"), TAG("scp_03"), TAG("scp_04"), TAG("scp_05"), TAG("scp_06"), TAG("scp_07"),
        TAG("scp_08"), TAG("scp_09"), TAG("scp_10"), TAG("scp_11"), TAG("scp_12"), TAG("scp_13"), TAG("scp_14"), TAG("scp_15"),
    };
    ...
    mpSIParent[0] = new CPaneMgr(mpScreen, TAG("tuta_n"), 2, NULL);
    JUT_ASSERT(0, mpSIParent[0] != NULL);

    mpSIParent[1] = new CPaneMgr(mpScreen, TAG("s_null"), 2, NULL);
...
void dMeter2Draw_c::initRupeeKey() {
    mpRupeeKeyParent = new CPaneMgr(mpScreen, TAG("r_k_n"), 2, NULL);
    JUT_ASSERT(0, mpRupeeKeyParent != NULL);
    field_0x718 = 1.0f;

    static u64 const rupeet1_tag[] = {TAG("r_n_1_s"), TAG("r_n_2_s"), TAG("r_n_3_s"), TAG("r_n_4_s")};
    static u64 const rupeet2_tag[] = {TAG("r_n_1"), TAG("r_n_2"), TAG("r_n_3"), TAG("r_n_4")};
    ...
    mpRupeeParent[0] = new CPaneMgr(mpScreen, TAG("rupi_n"), 2, NULL);
    JUT_ASSERT(0, mpRupeeParent[0] != NULL);

    mpRupeeParent[1] = new CPaneMgr(mpScreen, TAG("moyou_rn"), 2, NULL);
    JUT_ASSERT(0, mpRupeeParent[1] != NULL);

    mpRupeeParent[2] = new CPaneMgr(mpScreen, TAG("moyou_ln"), 2, NULL);
    ...
    static u64 const key_tag[] = {TAG("key_nul"), TAG("k_n_1_n"), TAG("k_n_2_n"), TAG("k_n_3_n"), TAG("k_n_4_n")};
    ...
    mpKeyParent = new CPaneMgr(mpScreen, TAG("key_n"), 2, NULL);
...
void dMeter2Draw_c::initButton() {
    ...
    mpItemB = new CPaneMgr(mpScreen, TAG("b_itm_p"), 0, NULL);
    ...
    mpItemXY[0] = new CPaneMgr(mpScreen, TAG("x_itm_p"), 0, NULL);
    ...
    mpItemXY[1] = new CPaneMgr(mpScreen, TAG("y_itm_p"), 0, NULL);
    ...
    mpItemR = new CPaneMgr(mpScreen, TAG("r_itm_p"), 0, NULL);
    ...
    mpLightB = new CPaneMgr(mpScreen, TAG("b_light"), 0, NULL);
    JUT_ASSERT(0, mpLightB != NULL);
    mpLightB->getPanePtr()->setBasePosition(J2DBasePosition_4);
    field_0x72c = 1.0f;
    mpLightB->hide();

    mpLightXY[0] = new CPaneMgr(mpScreen, TAG("x_light"), 0, NULL);
    JUT_ASSERT(0, mpLightXY[0] != NULL);
    mpLightXY[0]->getPanePtr()->setBasePosition(J2DBasePosition_4);
    mpLightXY[0]->hide();

    mpLightXY[1] = new CPaneMgr(mpScreen, TAG("y_light"), 0, NULL);
    JUT_ASSERT(0, mpLightXY[1] != NULL);
    mpLightXY[1]->getPanePtr()->setBasePosition(J2DBasePosition_4);
    mpLightXY[1]->hide();

    mpLightXY[2] = new CPaneMgr(mpScreen, TAG("r_light"), 0, NULL);
    JUT_ASSERT(0, mpLightXY[2] != NULL);
    mpLightXY[2]->getPanePtr()->setBasePosition(J2DBasePosition_4);
    mpLightXY[2]->hide();

    mpBTextA = new CPaneMgr(mpScreen, TAG("b_text_a"), 0, NULL);
    JUT_ASSERT(0, mpBTextA != NULL);

    mpBTextB = new CPaneMgr(mpScreen, TAG("b_text_b"), 0, NULL);
    JUT_ASSERT(0, mpBTextB != NULL);

    mpBTextXY[0] = new CPaneMgr(mpScreen, TAG("b_text_x"), 0, NULL);
    JUT_ASSERT(0, mpBTextXY[0] != NULL);

    mpBTextXY[1] = new CPaneMgr(mpScreen, TAG("b_text_y"), 0, NULL);
    JUT_ASSERT(0, mpBTextXY[1] != NULL);

    mpBTextXY[2] = NULL;

    mpTextA = new CPaneMgr(mpScreen, TAG("a_text_n"), 0, NULL);
    JUT_ASSERT(0, mpTextA != NULL);

    mpTextB = new CPaneMgr(mpScreen, TAG("b_text_n"), 0, NULL);
    JUT_ASSERT(0, mpTextB != NULL);

    mpTextXY[2] = new CPaneMgr(mpScreen, TAG("z_text_n"), 0, NULL);
    JUT_ASSERT(0, mpTextXY[2] != NULL);

    mpTextXY[0] = new CPaneMgr(mpScreen, TAG("x_text_n"), 0, NULL);
    JUT_ASSERT(0, mpTextXY[0] != NULL);

    mpTextXY[1] = new CPaneMgr(mpScreen, TAG("y_text_n"), 0, NULL);
    JUT_ASSERT(0, mpTextXY[1] != NULL);

    mpTextI = new CPaneMgr(mpScreen, TAG("i_text_n"), 2, NULL);
    JUT_ASSERT(0, mpTextI != NULL);

    mpTextM = new CPaneMgr(mpScreen, TAG("m_text_n"), 2, NULL);
    JUT_ASSERT(0, mpTextM != NULL);

    static u64 const juji_i_tag[] = {TAG("ju_ring4"), TAG("yaji_00"), TAG("yaji_01"), TAG("ju_ring2"), TAG("ju_ring4")};
    static u64 const juji_m_tag[] = {TAG("ju_ring3"), TAG("yaji_02"), TAG("yaji_03"), TAG("ju_ring3"), 0};
    ...
    mpButtonParent = new CPaneMgr(mpScreen, TAG("cont_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonParent != NULL);

    mpButtonA = new CPaneMgr(mpScreen, TAG("abtn_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonA != NULL);

    mpButtonB = new CPaneMgr(mpScreen, TAG("bbtn_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonB != NULL);
    field_0x730 = 1.0f;

    mpButtonMidona = new CPaneMgr(mpScreen, TAG("midona_n"), 2, NULL);
    ...
    mpButtonXY[0] = new CPaneMgr(mpScreen, TAG("xbtn_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonXY[0] != NULL);

    mpButtonXY[1] = new CPaneMgr(mpScreen, TAG("ybtn_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonXY[1] != NULL);

    mpButtonXY[2] = new CPaneMgr(mpScreen, TAG("zbtn_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonXY[2] != NULL);

    mpUzu = new CPaneMgrAlpha(mpScreen, TAG("uzu_n"), 2, NULL);
...
void dMeter2Draw_c::initButtonCross() {
    mpButtonCrossParent = new CPaneMgr(mpScreen, TAG("juji_n"), 2, NULL);
    JUT_ASSERT(0, mpButtonCrossParent != NULL);

    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju0")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju1")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju2")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju3")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju4")))->setFont(mDoExt_getMesgFont());

    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju0")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju1")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju2")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju3")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju4")))->setString(0x40, "");

    dMeter2Info_getString(
        0x61, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju0")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x61, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju1")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x61, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju2")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x61, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju3")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x61, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju4")))->getStringPtr(), NULL);

    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju5")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju6")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju7")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju8")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju9")))->setFont(mDoExt_getMesgFont());

    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju5")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju6")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju7")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju8")))->setString(0x40, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju9")))->setString(0x40, "");

    dMeter2Info_getString(
        0x62, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju5")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x62, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju6")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x62, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju7")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x62, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju8")))->getStringPtr(), NULL);
    dMeter2Info_getString(
        0x62, static_cast<J2DTextBox*>(mpScreen->search(TAG("cont_ju9")))->getStringPtr(), NULL);
...
void dMeter2Draw_c::setPikariBpkAnimation(J2DAnmColor* i_bpk) {
    mpPikariScreen->search(TAG("pika00"))->setAnimation(i_bpk);
    mpPikariScreen->search(TAG("moya00"))->setAnimation(i_bpk);
    mpPikariScreen->search(TAG("moyabs"))->setAnimation(i_bpk);
}
...
void dMeter2Draw_c::playOxygenBpkAnimation(J2DAnmColor* i_bpk) {
    if (i_bpk == NULL || mpMagicMeter->getAlpha() == 0) {
        mpKanteraScreen->search(TAG("mm_00"))->setAnimation((J2DAnmColor*)NULL);
    } else {
        field_0x558++;
        ...
        mpKanteraScreen->search(TAG("mm_00"))->setAnimation(i_bpk);
...
void dMeter2Draw_c::drawPikari(f32 i_posX, f32 i_posY, f32* i_framep, f32 i_scale,
    ...
    if (param_9 == 4) {
        var_f31 = 24.0f;
        if (mpPikariScreen->search(TAG("moya00"))->isVisible()) {
            mpPikariScreen->search(TAG("moya00"))->hide();
        }

        if (mpPikariScreen->search(TAG("moyabs"))->isVisible()) {
            mpPikariScreen->search(TAG("moyabs"))->hide();
        }
    } else {
        if (!mpPikariScreen->search(TAG("moya00"))->isVisible()) {
            mpPikariScreen->search(TAG("moya00"))->show();
        }

        if (!mpPikariScreen->search(TAG("moyabs"))->isVisible()) {
            mpPikariScreen->search(TAG("moyabs"))->show();
        }
    }
    ...
    if (param_9 != 3 && param_9 != 4 && param_9 != 5 && dMsgObject_isTalkNowCheck()) {
        ...
        *i_framep += param_8;
        ...
        if (mpPikariScreen->search(TAG("moya00"))->isVisible()) {
            static_cast<J2DPicture*>(mpPikariScreen->search(TAG("moya00")))
                ->setBlackWhite(i_moyaBlack, i_moyaWhite);
        }

        if (mpPikariScreen->search(TAG("moyabs"))->isVisible()) {
            static_cast<J2DPicture*>(mpPikariScreen->search(TAG("moyabs")))
                ->setBlackWhite(i_moyabsBlack, i_moyabsWhite);
        }

        if (param_9 != 4) {
            static_cast<J2DPicture*>(mpPikariScreen->search(TAG("pika00")))
...
void dMeter2Draw_c::changeTextureLife(int i_no, bool param_1, u8 i_quarterNum) {
    if (param_1) {
        if (i_quarterNum == 0xFF) {
            ...
            static u64 const tag_bigh[] = {TAG("bigh_00"), TAG("bigh_01"), TAG("bigh_02"), TAG("bigh_03")};
            ...
            static u64 const tag_du[] = {TAG("heart_ln"), TAG("heart_un")};
...
void dMeter2Draw_c::drawButtonB(u8 i_action, bool param_1, f32 i_posX, f32 i_posY, f32 i_textPosX,
    ...
    if (i_action == 0x26 || i_action == 0x2E) {
        mpScreen->search(TAG("item_b_n"))->show();
        var_r31 = 1;
        ...
        if (mButtonBItem != dComIfGs_getSelectEquipSword()) {
            ...
            case fpcNm_ITEM_LIGHT_SWORD:
                ...
                break;
            default:
                mpScreen->search(TAG("item_b_n"))->hide();
                var_r31 = 0;
            }
        }
...
void dMeter2Draw_c::drawButtonR(u8 unused0, u8 i_action, bool unused1, bool unused2) {
    mpScreen->search(TAG("item_r_n"))->hide();
    mpTextXY[2]->show();
...
void dMeter2Draw_c::drawButtonXY(int i_no, u8 i_itemNo, u8 i_action, bool param_3, bool param_4) {
    ...
    static u64 const tag[] = {TAG("item_x_n"), TAG("item_y_n")};
...
ResTIMG* dMeter2Draw_c::getNumberTexture(int i) {
    return (ResTIMG*)dComIfGp_getMain2DArchive()->getResource(TAG("TIMG"),
...
void dMeter2Draw_c::setItemNum(u8 i_button, u8 i_num, u8 i_max) {
    ...
    if (i_num < 100) {
        ResTIMG* timg = (ResTIMG*)dComIfGp_getMain2DArchive()->getResource(
            TAG("TIMG"), dMeter2Info_getNumberTextureName(i_num / 10));
        ...
        ResTIMG* timg = (ResTIMG*)dComIfGp_getMain2DArchive()->getResource(
            TAG("TIMG"), dMeter2Info_getNumberTextureName(i_num / 100));
        mpItemNumTex[i_button][0]->changeTexture(timg, 0);
