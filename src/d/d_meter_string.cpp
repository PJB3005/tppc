...
int dMeterString_c::_create() {
    ...
    mpParentPane = new CPaneMgr(mpScreen, TAG("get_in_n"), 2, NULL);
    JUT_ASSERT(0, mpParentPane != NULL);

    mpRootPane = new CPaneMgr(mpScreen, TAG("n_all"), 0, NULL);
    JUT_ASSERT(0, mpRootPane != NULL);

    mpTextPane = new CPaneMgr(mpScreen, TAG("get_in"), 0, NULL);
    JUT_ASSERT(0, mpTextPane != NULL);

    static_cast<J2DTextBox*>(mpScreen->search(TAG("get_in_s")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("get_in")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("get_in_s")))->setString(0x100, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("get_in")))->setString(0x100, "");
...
int dMeterString_c::createString(int i_stringID) {
    ...
    strcpy(static_cast<J2DTextBox*>(mpScreen->search(TAG("get_in_s")))->getStringPtr(), str_buf);
    strcpy(static_cast<J2DTextBox*>(mpScreen->search(TAG("get_in")))->getStringPtr(), str_buf);
