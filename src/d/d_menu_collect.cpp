...
void dMenu_Collect2D_c::screenSet() {
    static const u64 text_sv[3] = {TAG("sav_0"), TAG("sav_1"), TAG("sav_2")};
    static const u64 text_op[3] = {TAG("opt_0"), TAG("opt_1"), TAG("opt_2"),};
    static const u64 ftext_sv[3] = {TAG("f_sav_0"), TAG("f_sav_1"), TAG("f_sav_2")};
    static const u64 ftext_op[3] = {TAG("f_opt_0"), TAG("f_opt_1"), TAG("f_opt_2")};
...
#if REGION_JPN
    static_cast<J2DTextBox*>(mpScreen->search(TAG("t_t00")))->setFont(mDoExt_getRubyFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("t_t00")))->setString(0x20, "");
    dMeter2Info_getStringKanji(
        0x3E1, static_cast<J2DTextBox*>(mpScreen->search(TAG("t_t00")))->getStringPtr(), NULL);
    mpScreen->search(TAG("f_t00"))->hide();
#else
    static_cast<J2DTextBox*>(mpScreen->search(TAG("f_t00")))->setFont(mDoExt_getRubyFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("f_t00")))->setString(0x20, "");
    dMeter2Info_getStringKanji(
        0x3E1, static_cast<J2DTextBox*>(mpScreen->search(TAG("f_t00")))->getStringPtr(), NULL);
...
#if REGION_JPN
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n00")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n01")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n02")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n03")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n00")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n01")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n02")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n03")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text1")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text0")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text1")))->setString(0x100, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text0")))->setString(0x100, "");

    mpScreen->search(TAG("item_n04"))->hide();
    mpScreen->search(TAG("item_n05"))->hide();
    mpScreen->search(TAG("item_n06"))->hide();
    mpScreen->search(TAG("item_n07"))->hide();
    mpScreen->search(TAG("f_text1"))->hide();
    mpScreen->search(TAG("f_text0"))->hide();
#else
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n04")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n05")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n06")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n07")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n04")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n05")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n06")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n07")))->setString(0x20, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text1")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text0")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text1")))->setString(0x100, "");
    static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text0")))->setString(0x100, "");

    mpScreen->search(TAG("item_n00"))->hide();
    mpScreen->search(TAG("item_n01"))->hide();
    mpScreen->search(TAG("item_n02"))->hide();
    mpScreen->search(TAG("item_n03"))->hide();
    mpScreen->search(TAG("i_text1"))->hide();
    mpScreen->search(TAG("i_text0"))->hide();
#endif
    ...
    if (field_0x22d[3][0] != 0) {
        if (dComIfGs_isItemFirstBit(0x28)) {
            mpScreen->search(TAG("ken_00"))->hide();
            mpScreen->search(TAG("ken_01"))->show();
        } else if (dComIfGs_isItemFirstBit(0x3F)
                       /* dSv_event_flag_c::F_0026 - Ordon Village - gave wooden sword to talo on 3rd day */
                   && !dComIfGs_isEventBit(0x302)) {
            mpScreen->search(TAG("ken_00"))->show();
            mpScreen->search(TAG("ken_01"))->hide();
        }
    }
    ...
    if (field_0x22d[3][1] != 0) {
        if (dComIfGs_isItemFirstBit(0x2B)) {
            mpScreen->search(TAG("tate_00"))->show();
            mpScreen->search(TAG("tate_01"))->hide();
        } else if (dComIfGs_isItemFirstBit(0x2A)) {
            mpScreen->search(TAG("tate_00"))->hide();
            mpScreen->search(TAG("tate_01"))->show();
        }
    }
    ...
    mpLinkPm = new CPaneMgr(mpScreen, TAG("linki_n"), 0, NULL);
    ...
    mpMaskPm = new CPaneMgr(mpScreen, TAG("kamen_n"), 0, NULL);
    mpModelBg = new CPaneMgr(mpScreen, TAG("modelbgn"), 2, NULL);
    mpHeartParent = new CPaneMgr(mpScreen, TAG("heart_n"), 0, NULL);
    mpHeartPiece = new CPaneMgr(mpScreen, TAG("heart_kn"), 0, NULL);
...
void dMenu_Collect2D_c::btkAnimeLoop0(J2DAnmTextureSRTKey* i_SRTKey) {
    ...
    static_cast<J2DTextBox*>(mpScreen->search(TAG("modelbg0")))->setAnimation(i_SRTKey);
    static_cast<J2DTextBox*>(mpScreen->search(TAG("modelbg1")))->setAnimation(i_SRTKey);
    static_cast<J2DTextBox*>(mpScreen->search(TAG("modelbg2")))->setAnimation(i_SRTKey);
    static_cast<J2DTextBox*>(mpScreen->search(TAG("modelbg3")))->setAnimation(i_SRTKey);
    static_cast<J2DTextBox*>(mpScreen->search(TAG("modelbg4")))->setAnimation(i_SRTKey);
    static_cast<J2DTextBox*>(mpScreen->search(TAG("modelbg5")))->setAnimation(i_SRTKey);
}
...
void dMenu_Collect2D_c::setArrowMaxNum(u8 param_0) {
    switch (param_0) {
    case 0:
        mpScreen->search(TAG("item_0_0"))->hide();
        mpScreen->search(TAG("item_0_1"))->hide();
        mpScreen->search(TAG("item_0_2"))->hide();
        break;
    case 30:
        mpScreen->search(TAG("item_0_0"))->show();
        mpScreen->search(TAG("item_0_1"))->hide();
        mpScreen->search(TAG("item_0_2"))->hide();
        break;
    case 60:
        mpScreen->search(TAG("item_0_0"))->hide();
        mpScreen->search(TAG("item_0_1"))->show();
        mpScreen->search(TAG("item_0_2"))->hide();
        break;
    case 100:
        mpScreen->search(TAG("item_0_0"))->hide();
        mpScreen->search(TAG("item_0_1"))->hide();
        mpScreen->search(TAG("item_0_2"))->show();
        break;
    }
}
...
void dMenu_Collect2D_c::setWalletMaxNum(u16 i_walletSize) {
    switch (i_walletSize) {
    case 300:
        mpScreen->search(TAG("item_1_0"))->show();
        mpScreen->search(TAG("item_1_1"))->hide();
        mpScreen->search(TAG("item_1_2"))->hide();
        break;
    case 600:
        mpScreen->search(TAG("item_1_0"))->hide();
        mpScreen->search(TAG("item_1_1"))->show();
        mpScreen->search(TAG("item_1_2"))->hide();
        break;
    case 1000:
        mpScreen->search(TAG("item_1_0"))->hide();
        mpScreen->search(TAG("item_1_1"))->hide();
        mpScreen->search(TAG("item_1_2"))->show();
        break;
    }
}
...
void dMenu_Collect2D_c::setSmellType() {
    static const u64 smell_tag[5] = {
        TAG("wolf_med"), TAG("wolf_chi"), TAG("wolf_fis"), TAG("wolf_iri"), TAG("wolf_pou"),
    };
    s32 smellType = -1;
...
void dMenu_Collect2D_c::setPohMaxNum(u8 i_pohNum) {
    ...
    if (field_0x22d[0][3] != 0) {
        ...
        if (div > 0) {
            ...
            ResTIMG* timg = (ResTIMG*)archive->getResource(TAG("TIMG"), textureName);
            static_cast<J2DPicture*>(mpScreen->search(TAG("item2_3")))->changeTexture(timg, 0);
            check = 1;
        } else {
            mpScreen->search(TAG("item2_3"))->hide();
        }
        div = index / 10;
        index = index % 10;
        if (div != 0 || check != 0) {
            ...
            ResTIMG* timg2 = (ResTIMG*)archive->getResource(TAG("TIMG"), textureName2);
            static_cast<J2DPicture*>(mpScreen->search(TAG("item2_2")))->changeTexture(timg2, 0);
        } else {
            mpScreen->search(TAG("item2_2"))->hide();
        }
        JKRArchive* archive = dComIfGp_getMain2DArchive();
        const char* textureName3 = dMeter2Info_getNumberTextureName(index);
        ResTIMG* timg3 = (ResTIMG*)archive->getResource(TAG("TIMG"), textureName3);
        static_cast<J2DPicture*>(mpScreen->search(TAG("item2_1")))->changeTexture(timg3, 0);
    } else {
        mpScreen->search(TAG("item2_3"))->hide();
        mpScreen->search(TAG("item2_2"))->hide();
        mpScreen->search(TAG("item2_1"))->hide();
    }
}
...
void dMenu_Collect2D_c::setHIO(bool i_useHIO) {
    static const u64 kaz_n[9] = {
        TAG("uzu_00"), TAG("uzu_01"), TAG("uzu_02"), TAG("uzu_03"), TAG("uzu_04"), TAG("uzu_05"), TAG("uzu_06"), TAG("uzu_07"), TAG("hishi"),
    };
    ...
    if (g_drawHIO.mCollectScreen.mColorDebugON) {
        J2DPicture* basePicture = (J2DPicture*)mpScreen->search(TAG("nht_base"));
...
u64 dMenu_Collect2D_c::getItemTag(int i_tag1, int i_tag2, bool param_3) {
    static const u64 itemTag[6][7] = {
        {0, 0, 0, TAG("ken_n0"), TAG("ken_n1"), TAG("heart_kn"), TAG("kamen_n")},
        {0, 0, 0, TAG("tate_n0"), TAG("tate_n1")},
        {
            0,
            0,
            0,
...
#if REGION_JPN
        char* stringPtr1 = static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text1")))->getStringPtr();
#else
        char* stringPtr1 = static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text1")))->getStringPtr();
#endif
        strcpy(stringPtr1, "");

#if REGION_JPN
        char* stringPtr0 = static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text0")))->getStringPtr();
#else
        char* stringPtr0 = static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text0")))->getStringPtr();
#endif
        strcpy(stringPtr0, "");
    } else {
#if REGION_JPN
        J2DTextBox* textBox1 = static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text1")));
#else
        J2DTextBox* textBox1 = static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text1")));
#endif
        mpString->getString(mItemNameString, textBox1, NULL, NULL, NULL, 0);

#if REGION_JPN
        J2DTextBox* textBox0 = static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text0")));
#else
        J2DTextBox* textBox0 = static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text0")));
#endif
        mpString->getString(mItemNameString, textBox0, NULL, NULL, NULL, 0);

#if REGION_JPN
        textBox0 = static_cast<J2DTextBox*>(mpScreen->search(TAG("i_text0")));
#else
        textBox0 = static_cast<J2DTextBox*>(mpScreen->search(TAG("f_text0")));
#endif
...
#if REGION_JPN
            char* stringPtr =
                static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n00")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
            stringPtr = static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n01")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
            stringPtr = static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n02")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
            stringPtr = static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n03")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
#else
            char* stringPtr =
                static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n04")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
            stringPtr = static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n05")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
            stringPtr = static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n06")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
            stringPtr = static_cast<J2DTextBox*>(mpScreen->search(TAG("item_n07")))->getStringPtr();
            dMeter2Info_getStringKanji(uVar6, stringPtr, NULL);
#endif
        }
    }
...
void dMenu_Collect2D_c::setItemNameStringNull() {
    mItemNameString = 0;
#if REGION_JPN
    J2DTextBox* textBox = (J2DTextBox*)mpScreen->search(TAG("item_n00"));
    strcpy(textBox->getStringPtr(), "");
    textBox = (J2DTextBox*)mpScreen->search(TAG("item_n01"));
    strcpy(textBox->getStringPtr(), "");
    textBox = (J2DTextBox*)mpScreen->search(TAG("item_n02"));
    strcpy(textBox->getStringPtr(), "");
    textBox = (J2DTextBox*)mpScreen->search(TAG("item_n03"));
#else
    J2DTextBox* textBox = (J2DTextBox*)mpScreen->search(TAG("item_n04"));
    strcpy(textBox->getStringPtr(), "");
    textBox = (J2DTextBox*)mpScreen->search(TAG("item_n05"));
    strcpy(textBox->getStringPtr(), "");
    textBox = (J2DTextBox*)mpScreen->search(TAG("item_n06"));
    strcpy(textBox->getStringPtr(), "");
    textBox = (J2DTextBox*)mpScreen->search(TAG("item_n07"));
#endif
    strcpy(textBox->getStringPtr(), "");
}
