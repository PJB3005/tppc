...
dMsgScrnTalk_c::dMsgScrnTalk_c(u8 param_1, u8 param_2, JKRExpHeap* param_3) {
    ...
    field_0xe8 = mpScreen->search(TAG("n_all"))->getBounds().i.x;
    field_0xec = mpScreen->search(TAG("n_all"))->getBounds().i.y;
    field_0xf0 = 0.0f;
    for (int i = 0; i < 3; i++) {
    ...
    mpScreen->search(TAG("mg_null"))->move(
        mpScreen->search(TAG("mg_null"))->getBounds().i.x + g_MsgObject_HIO_c.mTextPosX, 
        mpScreen->search(TAG("mg_null"))->getBounds().i.y + g_MsgObject_HIO_c.mTextPosY);
    ...
    if (dComIfGs_getOptRuby() == 0) {
        ...
        if (dMsgObject_getMsgObjectClass()->getFukiKind() == 8) {
            mpTm_c[2] = new CPaneMgr(mpTxScreen, TAG("t3f_s1"), 0, NULL);
            mpTm_c[3] = new CPaneMgr(mpTxScreen, TAG("t3f_s2"), 0, NULL);
            mpTm_c[4] = new CPaneMgr(mpTxScreen, TAG("t3f_s3"), 0, NULL);
            mpTm_c[5] = new CPaneMgr(mpTxScreen, TAG("t3f_s4"), 0, NULL);
            mpTmr_c[1] = new CPaneMgr(mpTxScreen, TAG("mg_3f_s1"), 0, NULL);
            mpTmr_c[2] = new CPaneMgr(mpTxScreen, TAG("mg_3f_s2"), 0, NULL);
        } else {
        ...
        if (dMsgObject_getMsgObjectClass()->getFukiKind() == 8) {
            mpTm_c[2] = new CPaneMgr(mpTxScreen, TAG("t3_s1"), 0, NULL);
            JUT_ASSERT(189, mpTm_c[2] != NULL);
            mpTm_c[3] = new CPaneMgr(mpTxScreen, TAG("t3_s2"), 0, NULL);
            JUT_ASSERT(191, mpTm_c[3] != NULL);
            mpTm_c[4] = new CPaneMgr(mpTxScreen, TAG("t3_s3"), 0, NULL);
            JUT_ASSERT(193, mpTm_c[4] != NULL);
            mpTm_c[5] = new CPaneMgr(mpTxScreen, TAG("t3_s4"), 0, NULL);
    ...
    if (dMsgObject_getMsgObjectClass()->getFukiKind() == 8) {
        mpTm_c[2] = new CPaneMgr(mpTxScreen, TAG("t4_s1"), 0, NULL);
        JUT_ASSERT(189, mpTm_c[2] != NULL);
        mpTm_c[3] = new CPaneMgr(mpTxScreen, TAG("t4_s2"), 0, NULL);
        JUT_ASSERT(191, mpTm_c[3] != NULL);
        mpTm_c[4] = new CPaneMgr(mpTxScreen, TAG("t4_s3"), 0, NULL);
        JUT_ASSERT(193, mpTm_c[4] != NULL);
        mpTm_c[5] = new CPaneMgr(mpTxScreen, TAG("t4_s4"), 0, NULL);
        JUT_ASSERT(193, mpTm_c[5] != NULL);
    }
...
void dMsgScrnTalk_c::fukiPosCalc(u8 param_1) {
    ...
    case 1:
        ...
        field_0xf0 = 105.0f - (mpScreen->search(TAG("n_all"))->getBounds().i.y +
                               mpScreen->search(TAG("n_all"))->getBounds().f.y) / 2;
        if (mpSelect_c != NULL) {
    ...
    case 2:
        ...
        field_0xf0 = 235.0f - (mpScreen->search(TAG("n_all"))->getBounds().i.y +
                               mpScreen->search(TAG("n_all"))->getBounds().f.y) / 2;
        if (mpSelect_c != NULL) {
    ...
    if (dComIfGp_isHeapLockFlag() == 2 || dComIfGp_isHeapLockFlag() == 3) {
        ...
        mpScreen->search(TAG("n_all"))->move(field_0xe8, field_0xec - 190.0f);
    } else {
        setTextBoxPosOffsetY(field_0xf0 + dVar15);
        mpScreen->search(TAG("n_all"))->move(field_0xe8, field_0xec + field_0xf0 + dVar15);
    }
    if (mpPmP_c != NULL) {
        mpPmP_c->reinit();
