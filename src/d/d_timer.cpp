...
void dDlst_TimerScrnDraw_c::setScreen(s32 param_0, JKRArchive* i_archive) {
    ...
    mpGetInParent = new CPaneMgr(mpGetInScreen, TAG("get_in_n"), 2, NULL);
    JUT_ASSERT(0, mpGetInParent != NULL);

    mpGetInRoot = new CPaneMgr(mpGetInScreen, TAG("n_all"), 0, NULL);
    JUT_ASSERT(0, mpGetInRoot != NULL);

    mpGetInText = new CPaneMgr(mpGetInScreen, TAG("get_in"), 0, NULL);
    JUT_ASSERT(0, mpGetInText != NULL);

    static_cast<J2DTextBox*>(mpGetInScreen->search(TAG("get_in_s")))->setFont(mDoExt_getMesgFont());
    static_cast<J2DTextBox*>(mpGetInScreen->search(TAG("get_in")))->setFont(mDoExt_getMesgFont());
...
void dDlst_TimerScrnDraw_c::setScreenBase() {
    ...
    mpCowParent = new CPaneMgr(mpScreen, TAG("cow_n"), 2, NULL);
    JUT_ASSERT(0, mpCowParent != NULL);
    mpCowParent->setAlphaRate(0.0f);

    mpTimeParent = new CPaneMgr(mpScreen, TAG("time_n"), 2, NULL);
    JUT_ASSERT(0, mpTimeParent != NULL);
    mpTimeParent->setAlphaRate(0.0f);

    mpImageParent = new CPaneMgr(mpScreen, TAG("cow_i_n"), 2, NULL);
    JUT_ASSERT(0, mpImageParent != NULL);
    mpImageParent->setAlphaRate(0.0f);

    field_0x5c[0][0] = mpScreen->search(TAG("c_n_2"));
    field_0x5c[0][1] = mpScreen->search(TAG("c_n_2_s"));
    field_0x5c[1][0] = mpScreen->search(TAG("c_n_1"));
    field_0x5c[1][1] = mpScreen->search(TAG("c_n_1_s"));

    field_0x6c[0] = static_cast<J2DPicture*>(mpScreen->search(TAG("c_n_4")));
    field_0x6c[1] = static_cast<J2DPicture*>(mpScreen->search(TAG("c_n_4_s")));
    field_0x74[0] = static_cast<J2DPicture*>(mpScreen->search(TAG("c_n_3")));
    field_0x74[1] = static_cast<J2DPicture*>(mpScreen->search(TAG("c_n_3_s")));

    mTimerText[0][0] = mpScreen->search(TAG("t_n_6"));
    mTimerText[0][1] = mpScreen->search(TAG("t_n_6_s"));
    mTimerText[1][0] = mpScreen->search(TAG("t_n_5"));
    mTimerText[1][1] = mpScreen->search(TAG("t_n_5_s"));
    mTimerText[2][0] = mpScreen->search(TAG("t_n_4"));
    mTimerText[2][1] = mpScreen->search(TAG("t_n_4_s"));
    mTimerText[3][0] = mpScreen->search(TAG("t_n_3"));
    mTimerText[3][1] = mpScreen->search(TAG("t_n_3_s"));
    mTimerText[4][0] = mpScreen->search(TAG("t_n_2"));
    mTimerText[4][1] = mpScreen->search(TAG("t_n_2_s"));
    mTimerText[5][0] = mpScreen->search(TAG("t_n_1"));
    mTimerText[5][1] = mpScreen->search(TAG("t_n_1_s"));
}
...
void dDlst_TimerScrnDraw_c::setScreenBoatRace() {
    ...
    mpParent = new CPaneMgr(mpScreen, TAG("ta_co_n"), 2, NULL);
    JUT_ASSERT(0, mpParent != NULL);

    mpCowParent = new CPaneMgr(mpScreen, TAG("num_n"), 2, NULL);
    JUT_ASSERT(0, mpCowParent != NULL);
    mpCowParent->setAlphaRate(0.0f);

    mpTimeParent = NULL;

    mpImageParent = new CPaneMgr(mpScreen, TAG("target_n"), 2, NULL);
    JUT_ASSERT(0, mpImageParent != NULL);
    mpImageParent->setAlphaRate(0.0f);

    mpScreen->search(TAG("w_target"))->hide();
    mpScreen->search(TAG("target"))->show();
    ...
    field_0x6c[0] = static_cast<J2DPicture*>(mpScreen->search(TAG("num_1")));
    field_0x6c[1] = NULL;
    field_0x74[0] = static_cast<J2DPicture*>(mpScreen->search(TAG("num_0")));
    field_0x74[1] = NULL;
...
void dDlst_TimerScrnDraw_c::setScreenRider() {
    ...
    mpImageParent = new CPaneMgr(mpScreen, TAG("rid_i_n"), 2, NULL);
    JUT_ASSERT(0, mpImageParent != NULL);
    mpImageParent->setAlphaRate(0.0f);

    field_0x5c[0][0] = mpScreen->search(TAG("n_n_2"));
    field_0x5c[0][1] = mpScreen->search(TAG("n_n_2_s"));
    field_0x5c[1][0] = mpScreen->search(TAG("n_n_1"));
    field_0x5c[1][1] = mpScreen->search(TAG("n_n_1_s"));

    field_0x6c[0] = static_cast<J2DPicture*>(mpScreen->search(TAG("n_n_4")));
    field_0x6c[1] = static_cast<J2DPicture*>(mpScreen->search(TAG("n_n_4_s")));
    field_0x74[0] = static_cast<J2DPicture*>(mpScreen->search(TAG("n_n_3")));
    field_0x74[1] = static_cast<J2DPicture*>(mpScreen->search(TAG("n_n_3_s")));
...
void dDlst_TimerScrnDraw_c::hideDenominator() {
    ...
    if (field_0x3C8 == 8) {
        mpScreen->search(TAG("n_sl_s"))->hide();
        mpScreen->search(TAG("n_sl"))->hide();
    } else {
        J2DPane* sl_s = mpScreen->search(TAG("c_sl_s"));
        J2DPane* sl = mpScreen->search(TAG("c_sl"));
...
void dDlst_TimerScrnDraw_c::changeNumberTexture(J2DPane* i_pane, int i_num) {
    ...
    dComIfGp_getMain2DArchive()->getResource(TAG("TIMG"), getNumber(i_num));
...
int dDlst_TimerScrnDraw_c::createGetIn(cXyz i_pos) {
    ...
    strcpy(static_cast<J2DTextBox*>(mpGetInScreen->search(TAG("get_in_s")))->getStringPtr(), string);
    strcpy(static_cast<J2DTextBox*>(mpGetInScreen->search(TAG("get_in")))->getStringPtr(), string);
