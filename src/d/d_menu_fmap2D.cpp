...
dMenu_Fmap2DBack_c::dMenu_Fmap2DBack_c() {
    ...
    mpBaseRoot = new CPaneMgrAlphaMorf(mpBaseScreen, TAG("ROOT"), 2, NULL);
    JUT_ASSERT(264, mpBaseRoot != NULL);

    mpMapArea = new CPaneMgr(mpBaseScreen, TAG("center_n"), 0, NULL);
    JUT_ASSERT(269, mpMapArea != NULL);

    mpMapBlack = new CPaneMgr(mpBaseScreen, TAG("map_blak"), 0, NULL);
    ...
    ResTIMG* backTexResource =
        (ResTIMG*)dComIfGp_getMain2DArchive()->getResource(TAG("TIMG"), "tt_block8x8.bti");
    ...
    mpPointParent = new CPaneMgr(mpPointScreen, TAG("f_po_n"), 2, NULL);
    JUT_ASSERT(301, mpPointParent != NULL);

    mpPointParent->scale(g_fmapHIO.mCursorScale, g_fmapHIO.mCursorScale);

    static const u64 cur_tag[4] = {TAG("f_po_ru"), TAG("f_po_rd"), TAG("f_po_ld"), TAG("f_po_lu")};
...
void dMenu_Fmap2DBack_c::btkAnimeLoop(f32 i_step) {
    ...
    mpBaseScreen->search(TAG("gold00_0"))->setAnimation(mpBaseAnm);
    mpBaseScreen->search(TAG("gold00_1"))->setAnimation(mpBaseAnm);
...
dMenu_Fmap2DTop_c::dMenu_Fmap2DTop_c(JKRExpHeap* i_heap, STControl* i_stick) {
    ...
    mpTitleRoot = new CPaneMgrAlphaMorf(mpTitleScreen, TAG("ROOT"), 2, NULL);
    ...
    mpAnalogStick = NULL;
    mpDpad = NULL;
    mpTitleScreen->search(TAG("tri_Null"))->hide();
#endif
#if PLATFORM_GCN
    mpArrowLAlpha[0] = new CPaneMgrAlpha(mpTitleScreen, TAG("yaji_04"), 0, NULL);
    mpArrowLAlpha[1] = new CPaneMgrAlpha(mpTitleScreen, TAG("yaji_05"), 0, NULL);
    mpArrowRAlpha[0] = new CPaneMgrAlpha(mpTitleScreen, TAG("yaji_06"), 0, NULL);
    mpArrowRAlpha[1] = new CPaneMgrAlpha(mpTitleScreen, TAG("yaji_07"), 0, NULL);
    
    mpDpadAlpha = new CPaneMgrAlpha(mpTitleScreen, TAG("juji_c_n"), 2, NULL);
    mpDpadAlpha->setAlphaRate(0.0f);
    mpAnalogStickAlpha = new CPaneMgrAlpha(mpTitleScreen, TAG("as_n"), 2, NULL);
    mpAnalogStickAlpha->setAlphaRate(0.0f);
    mpAnalogStick = new CPaneMgr(mpTitleScreen, TAG("as_n"), 0, NULL);
    mpDpad = new CPaneMgr(mpTitleScreen, TAG("juji_c_n"), 0, NULL);
#endif
#if PLATFORM_SHIELD
    mpButtonA = new CPaneMgr(mpTitleScreen, TAG("abtn_n"), 2, NULL);
    JUT_ASSERT(3935, mpButtonA != NULL);
    mpButtonB = new CPaneMgr(mpTitleScreen, TAG("bbtn_n"), 2, NULL);
    JUT_ASSERT(3938, mpButtonB != NULL);
    mpButtonZ = new CPaneMgr(mpTitleScreen, TAG("j_scal_n"), 2, NULL);
    JUT_ASSERT(3941, mpButtonZ != NULL);
    mpButtonTextA = new CPaneMgr(mpTitleScreen, TAG("a_text_n"), 2, NULL);
    JUT_ASSERT(3953, mpButtonTextA != NULL);
    mpButtonTextB = new CPaneMgr(mpTitleScreen, TAG("b_text_n"), 2, NULL);
    JUT_ASSERT(3956, mpButtonTextB != NULL);
    mpButtonTextZ = new CPaneMgr(mpTitleScreen, TAG("z_text_n"), 2, NULL);
    JUT_ASSERT(3959, mpButtonTextZ != NULL);
#else
    mpButtonA = new CPaneMgr(mpTitleScreen, TAG("abtn_n1"), 2, NULL);
    JUT_ASSERT(3935, mpButtonA != NULL);
    mpButtonB = new CPaneMgr(mpTitleScreen, TAG("bbtn_n1"), 2, NULL);
    JUT_ASSERT(3938, mpButtonB != NULL);
    mpButtonZ = new CPaneMgr(mpTitleScreen, TAG("zbtn_n1"), 2, NULL);
    JUT_ASSERT(3941, mpButtonZ != NULL);
    mpButtonTextA = new CPaneMgr(mpTitleScreen, TAG("a_text_n"), 2, NULL);
    JUT_ASSERT(3953, mpButtonTextA != NULL);
    mpButtonTextB = new CPaneMgr(mpTitleScreen, TAG("b_text_n"), 2, NULL);
    ...
    mpNamePane = new CPaneMgr(mpTitleScreen, TAG("name_n"), 0, NULL);
    JUT_ASSERT(3970, mpNamePane != NULL);
    mpSubPane = new CPaneMgr(mpTitleScreen, TAG("sub_n_n"), 0, NULL);
    ...
    mpContPane = new CPaneMgr(mpTitleScreen, TAG("cont_n"), 0, NULL);
    ...
    static const u64 area_name[3] = {TAG("i_name_s"), TAG("i_name") ,TAG("i_name1")};
    static const u64 farea_name[3] = {TAG("f_name_1"), TAG("f_name3"), TAG("f_name2")};
    for (int i = 0; i < 3; i++) {
    ...
    static const u64 sfont_name[7] = {
        TAG("sfont00"), TAG("sfontl0"), TAG("sfontl1"), TAG("sfontl2"), TAG("sfontb0"), TAG("sfontb1"), TAG("sfontb2")
    };
    static const u64 ffont_name[7] = {
        TAG("ffont00"), TAG("ffontl0"), TAG("ffontl1"), TAG("ffontl2"), TAG("ffontb0"), TAG("ffontb3"), TAG("ffontb4")
    };
#else
    static const u64 sfont_name[7] = {
        TAG("sfont00"), TAG("sfontl0"), TAG("sfontl1"), TAG("sfontl2"), TAG("sfontb0"), TAG("sfontb1"), TAG("sfontb2")
    ...
    static const u64 ffont_name[7] = {
        TAG("ffont01"), TAG("ffontl3"), TAG("ffontl4"), TAG("ffontl5"), TAG("ffontb3"), TAG("ffontb4"), TAG("ffontb5")
    };
#endif
    for (int i = 0; i < 7; i++) {
#if VERSION == VERSION_GCN_JPN
    ...
    static const u64 cont_zt[5] = {TAG("cont_zt"), TAG("cont_zt1"), TAG("cont_zt2"), TAG("cont_zt3"), TAG("cont_zt4")};
    static const u64 font_zt[5] = {TAG("font_zt1"), TAG("font_zt2"), TAG("font_zt3"), TAG("font_zt4"), TAG("font_zt5")};
    for (int i = 0; i < 5; i++) {
#if VERSION == VERSION_GCN_JPN
...
#if PLATFORM_GCN
    static const u64 cont_bt[5] = {TAG("cont_bt1"), TAG("cont_bt2"), TAG("cont_bt3"), TAG("cont_bt4"), TAG("cont_bt")};
    static const u64 font_bt[5] = {TAG("font_bt1"), TAG("font_bt2"), TAG("font_bt3"), TAG("font_bt4"), TAG("font_bt5")};
#else
    static const u64 cont_bt[5] = {TAG("cont_bt1"), TAG("cont_bt2"), TAG("cont_bt3"), TAG("cont_bt4"), TAG("cont_bt8")};
    static const u64 font_bt[5] = {TAG("font_bt1"), TAG("font_bt2"), TAG("font_bt3"), TAG("font_bt4"), TAG("font_bt5")};
#endif
    for (int i = 0; i < 5; i++) {
#if VERSION == VERSION_GCN_JPN
    ...
    static const u64 cont_at[5] = {TAG("cont_at"), TAG("cont_at1"), TAG("cont_at2"), TAG("cont_at3"), TAG("cont_at4")};
    static const u64 font_at[5] = {TAG("font_at1"), TAG("font_at2"), TAG("font_at3"), TAG("font_at4"), TAG("font_at5")};
    for (int i = 0; i < 5; i++) {
#if VERSION == VERSION_GCN_JPN
...
#if PLATFORM_GCN
    static const u64 juji_c[5] = {TAG("juji_c00"), TAG("juji_c01"), TAG("juji_c02"), TAG("juji_c03"), TAG("juji_c04")};
    static const u64 fuji_c[5] = {TAG("fuji_c00"), TAG("fuji_c01"), TAG("fuji_c02"), TAG("fuji_c03"), TAG("fuji_c04")};
    for (int i = 0; i < 5; i++) {
#if VERSION == VERSION_GCN_JPN
    ...
    static const u64 ast_c[5] = {TAG("ast_00"), TAG("ast_01"), TAG("ast_02"), TAG("ast_03"), TAG("ast_04")};
    static const u64 fst_c[5] = {TAG("fst_00"), TAG("fst_01"), TAG("fst_02"), TAG("fst_03"), TAG("fst_04")};
    for (int i = 0; i < 5; i++) {
#if VERSION == VERSION_GCN_JPN
...
void dMenu_Fmap2DTop_c::btkAnimeLoop(J2DAnmTextureSRTKey* i_anm, f32 i_delta) {
    ...
    mpTitleScreen->search(TAG("spot_0"))->setAnimation(i_anm);
    mpTitleScreen->animation();
}

void dMenu_Fmap2DTop_c::setMoyaAlpha(u8 i_alpha) {
    mpTitleScreen->search(TAG("spot_0"))->setAlpha(i_alpha);
}
...
#if VERSION == VERSION_GCN_JPN
    static const u64 iarea_name[3] = {TAG("i_name_s"), TAG("i_name"), TAG("i_name1")};
...
void dMenu_Fmap2DTop_c::setCrossLRString(u32 param_0) {
    ...
    static const u64 juji_c[5] = {TAG("juji_c00"), TAG("juji_c01"), TAG("juji_c02"), TAG("juji_c03"), TAG("juji_c04")};
#else
    static const u64 juji_c[5] = {TAG("fuji_c00"), TAG("fuji_c01"), TAG("fuji_c02"), TAG("fuji_c03"), TAG("fuji_c04")};
#endif
    if (param_0 == 0) {
        for (int i = 0; i < 5; i++) {
        ...
        mpTitleScreen->search(TAG("juy_sha0"))->show();
        mAlphaDpad = 1;
    } else {
        for (int i = 0; i < 5; i++) {
            J2DTextBox* text_box = static_cast<J2DTextBox*>(mpTitleScreen->search(juji_c[i]));
...
void dMenu_Fmap2DTop_c::set3DStickString(u32 param_0) {
    ...
    static const u64 ast_c[5] = {TAG("ast_00"), TAG("ast_01"), TAG("ast_02"), TAG("ast_03"), TAG("ast_04")};
#else
    static const u64 ast_c[5] = {TAG("fst_00"), TAG("fst_01"), TAG("fst_02"), TAG("fst_03"), TAG("fst_04")};
#endif
    if (param_0 == 0) {
        for (int i = 0; i < 5; i++) {
        ...
        mpTitleScreen->search(TAG("as_sha0"))->show();
        mAlphaAnalogStick = 1;
    } else {
        for (int i = 0; i < 5; i++) {
            J2DTextBox* text_box = static_cast<J2DTextBox*>(mpTitleScreen->search(ast_c[i]));
