...
int dMeterHakusha_c::_create() {
    static u64 haku_tag[] = {
        TAG("haku_n00"), TAG("haku_n01"), TAG("haku_n02"), TAG("haku_n03"), TAG("haku_n04"), TAG("haku_n05"),
    };
    ...
    mpHakushaParent = new CPaneMgr(field_0x004, TAG("hakunall"), 0, NULL);
    ...
    mpHakushaOn = new CPaneMgr(mpHakushaScreen, TAG("haku_n"), 2, NULL);
    JUT_ASSERT(0, mpHakushaOn != NULL);

    mpHakushaOff = new CPaneMgr(mpHakushaScreen, TAG("haku_b_n"), 2, NULL);
    ...
    mpButtonScreen->search(TAG("info_n"))->translate(0.0f, 0.0f);
