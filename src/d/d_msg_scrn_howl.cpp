...
dMsgScrnHowl_c::dMsgScrnHowl_c() {
    ...
    static u64 tlinen_tag[7] = {
        TAG("tlinen00"), TAG("tlinen01"), TAG("tlinen02"), TAG("tlinen03"), TAG("tlinen04"), TAG("tlinen05"), TAG("tlinen06"),
    };
    static u64 tline_tag[7] = {
        TAG("tline00"), TAG("tline01"), TAG("tline02"), TAG("tline03"), TAG("tlinen04"), TAG("tline05"), TAG("tline06"),
    };
    static u64 tlines_tag[7] = {
        TAG("tlines00"), TAG("tlines01"), TAG("tlines02"), TAG("tlines03"), TAG("tlines04"), TAG("tlines05"), TAG("tlines06"),
    };
    ...
    mpScreen->search(TAG("line00"))->hide();
    mpPmP_c = new CPaneMgr(mpScreen, TAG("n_all"), 3, NULL);
    JUT_ASSERT(79, mpPmP_c != NULL);
    mpScreen->search(TAG("ag_n"))->hide();
    field_0x1994 = 0.0f;
    field_0x1998 = 0.0f;
    mpScreen->search(TAG("wi_btn_n"))->hide();
    mpButtonIcon[0] = new CPaneMgr(mpScreen, TAG("cbtn_n"), 2, NULL);
    JUT_ASSERT(91, mpButtonIcon[0] != NULL);
    mpButtonText[0] = new CPaneMgr(mpScreen, TAG("g_ltxt_n"), 2, NULL);
    JUT_ASSERT(93, mpButtonText[0] != NULL);
    mpButtonIcon[1] = new CPaneMgr(mpScreen, TAG("abt_n"), 2, NULL);
    JUT_ASSERT(96, mpButtonIcon[1] != NULL);
    mpButtonText[1] = new CPaneMgr(mpScreen, TAG("gr_txt_n"), 2, NULL);
    JUT_ASSERT(98, mpButtonText[1] != NULL);
#if VERSION == VERSION_GCN_JPN
    J2DTextBox* piStack_19c = (J2DTextBox*)mpScreen->search(TAG("g_l_info"));
    J2DTextBox* piStack_1a0 = (J2DTextBox*)mpScreen->search(TAG("g_r_info"));
    mpScreen->search(TAG("fgr_info"))->hide();
    mpScreen->search(TAG("fgl_info"))->hide();
#else
    J2DTextBox* piStack_19c = (J2DTextBox*)mpScreen->search(TAG("fgl_info"));
    J2DTextBox* piStack_1a0 = (J2DTextBox*)mpScreen->search(TAG("fgr_info"));
    mpScreen->search(TAG("g_l_info"))->hide();
    mpScreen->search(TAG("g_r_info"))->hide();
#endif
    ...
    mpABase = new CPaneMgr(mpScreen, TAG("a_base"), 0, NULL);
    JUT_ASSERT(218, mpABase != NULL);
    mpLineAll = new CPaneMgr(mpScreen, TAG("line_all"), 0, NULL);
    ...
    field_0x27a4 = 1.0f;
    field_0x27a8 = 0.0f;
    ResTIMG const* res = (ResTIMG const*) dComIfGp_getMsgArchive(5)->getResource(TAG("TIMG"), "tt_ginnouroko_s3tc.bti");
    mpDot = new J2DPicture(res);
    JUT_ASSERT(275, mpDot != NULL);
    mpDot->setWhite(JUtility::TColor(0xff, 0xff, 0x71, 0xff));
    res = (ResTIMG const*)dComIfGp_getMsgArchive(5)->getResource(TAG("TIMG"), "tt_black_32.bti");
    mpGuideDot = new J2DPicture(res);
    JUT_ASSERT(280, mpGuideDot != NULL);
    mpGuideDot->setBlackWhite(((J2DPicture*)mpScreen->search(TAG("line00")))->getBlack(), ((J2DPicture*)mpScreen->search(TAG("line00")))->getWhite());
    res = (ResTIMG const*)dComIfGp_getMain2DArchive()->getResource(TAG("TIMG"), "tt_iastarRR.bti");
    ...
    field_0x2134 = 0;
    field_0x1988 = mpScreen->search(TAG("line00"))->getWidth();
    field_0x198c = mpScreen->search(TAG("line00"))->getHeight();
    field_0x2194 = daAlink_getAlinkActorClass()->getCorrectCurveID();
    mCorrectLineMax = 0;
    field_0x2197 = 0;
    res = (ResTIMG const*)dComIfGp_getMain2DArchive()->getResource(TAG("TIMG"), "tt_block8x8.bti");
...
void dMsgScrnHowl_c::drawGuide() {
    ...
    for (int i = 0; i < 0x15d; i++) {
        ...
        if (local_e4 > 0.0f && local_ec > 0.0f && local_e4 == local_ec) {
            ...
            if (dVar16 > 0.0f) {
                mpGuideDot->setAlpha(
                    dVar16 * (mpScreen->search(TAG("line00"))->getAlpha() * mpPmP_c->getAlphaRate()));
        ...
        if (local_90 > 0.0f && local_9c > 0.0f && local_90 == local_9c) {
            ...
            if (guideAlpha > 0.0f && local_94 > 0.0f) {
                mpGuideDot->setAlpha(local_94 *
                                     (guideAlpha * (mpScreen->search(TAG("line00"))->getAlpha() *
...
void dMsgScrnHowl_c::drawEffect() {
    ...
    u8 screenAlpha = mpScreen->search(TAG("line00"))->getAlpha();
