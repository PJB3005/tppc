...
dMsgScrnKanban_c::dMsgScrnKanban_c(JKRExpHeap* param_0) {
    ...
    mpBack_c = new CPaneMgr(mpScreen, TAG("back_b"), 0, NULL);
    JUT_ASSERT(68, mpBack_c != NULL);

    mpSpot_c = new CPaneMgr(mpScreen, TAG("spot00"), 0, NULL);
    ...
    if (dComIfGs_getOptRuby() != 0) {
        ...
        static u64 const t_tag_2[3] = {TAG("t3fline"), TAG("t3f_w"), TAG("t3f_s")};
